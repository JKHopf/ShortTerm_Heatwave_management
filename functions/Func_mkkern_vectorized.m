function kxy = Func_mkkern_vectorized(fixparm, RR)
...
% Populate the kernel ---------------------
    ...
    isjuv = 1 - normcdf(x,fixparm.Lfish,fixparm.Lvar); 

    % SURVIVAL PART OF KERNEL
        % natural mortality rate
        % process error
        % + convert mortality rate to survivorship exp()
        ...
        m = M + repmat((1-isjuv).*fixparm.F,1,1,RR); 
